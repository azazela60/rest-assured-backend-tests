...
public class ImageTests extends BaseTest {
    ...
    void beforeTest() {
        ...
        multiPartSpecWithFile = new MultiPartSpecBuilder(new File("src/test/resources/Malamut.jpeg"))
                .controlName("image")
                .build();
        ...
        requestSpecificationWithAuthAndMultipartImage = new RequestSpecBuilder()
                ...
                .addFormParam("favorite","in_gallery")
    ...
    private byte[] getFileContent() {
        ...
        try {
            String PATH_TO_IMAGE = "src/test/resources/Malamut.jpeg";
